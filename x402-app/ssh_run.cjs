...
conn.on('ready', () => {
  ...
  conn.exec('~/nodevenv/x402-app/20/bin/node /tmp/test_mainnet.cjs', (err, stream) => {
...
.connect({ host: 'aptum.fun', port: 21098, username: 'aptumfun', privateKey, passphrase: '14785Sayeed@' });
